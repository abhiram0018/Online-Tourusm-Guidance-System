...
echo "<td>$column[0]</td>";
echo "<td>$column[1]</td>";
echo '<td><a class="btn btn-xs btn-warning" href = "editcategory.php?id='.$column['cid'].'">Edit</a></td>';
echo '<td><a class="btn btn-xs btn-warning" href = "deletecategory.php?id='.$column['cid'].'">Remove</a></td>';
}
echo "</tbody>";
