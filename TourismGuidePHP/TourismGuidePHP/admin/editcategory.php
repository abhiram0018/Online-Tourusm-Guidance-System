...
echo "<tr><th>Category ID</th><td><input type = text value='$column[0]' readonly></td></tr>";
echo "<tr><th>Category Name</th><td><input type = text value='$column[1]'   name='cname'></td></tr>";
